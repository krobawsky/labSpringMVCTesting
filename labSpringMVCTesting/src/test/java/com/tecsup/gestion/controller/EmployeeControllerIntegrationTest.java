...
public class EmployeeControllerIntegrationTest {
	...
	public void list2() throws Exception {
		...
		.andExpect(model().attribute("employees",
				hasItem(allOf(  
								hasProperty("employeeId", is(666)),
								hasProperty("login", is("rberrospi")),
								hasProperty("password", is("awdr")),
								hasProperty("firstname", is("Ricardo")),
								hasProperty("lastname", is("Berrospi")), 
								hasProperty("salary", is(5000)),
								hasProperty("departmentId", is(7))
							))));
	}

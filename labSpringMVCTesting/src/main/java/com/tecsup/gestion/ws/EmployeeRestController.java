...
public class EmployeeRestController {
	 ...
	 */
	@PostMapping("/emp")
	public ResponseEntity<Void> createUser(@RequestBody Employee emp, UriComponentsBuilder ucBuilder) throws DAOException, EmptyResultException {

		logger.info("Creating User " + emp.getLogin());
		
		boolean val = employeeService.isEmployeeExist(emp);
	 ...
	 */
	@GetMapping("/dep")
	public ResponseEntity<List<Employee>> listDep() {

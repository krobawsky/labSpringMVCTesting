...
public class EmployeeDAOImpl implements EmployeeDAO {
	...
	@Override
	public Employee findEmployee2(String firstname, String lastname, int salary) throws DAOException, EmptyResultException {

		String query = "SELECT employee_id, login, password, first_name, last_name, salary, department_id "
				+ " FROM employees WHERE first_name = ? AND last_name = ? AND salary = ?";

		Object[] params = new Object[] { firstname, lastname, salary };
